...
class TestTicTacToeConstructorAndNames(unittest.TestCase):

    def setUp(self):
        self.my_tictactoe = TicTacToe()

    def test_constructor_is_working(self):
        self.assertEqual(self.my_tictactoe.board, None)
        ...
        self.assertEqual(self.my_tictactoe.num_squares, 0)
        self.assertEqual(self.my_tictactoe.player1, '')
        self.assertEqual(self.my_tictactoe.player2, '')
    ...
    def test_players_name_right(self):
        ...
        self.my_tictactoe.player1 = 'Test'
        self.my_tictactoe.player2 = 'Test2'
        names_ok = self.my_tictactoe.players_name_ok(max_size = 10)
        self.assertTrue(names_ok)
        self.my_tictactoe.player2 = 'Test2Test2Test2Test2'
        names_ok = self.my_tictactoe.players_name_ok(max_size = 10)
        self.assertFalse(names_ok)

    def test_who_wins_works(self):
        self.my_tictactoe.num_squares = 5
        self.my_tictactoe.player1 = 'Test'
        self.my_tictactoe.player2 = 'Test2'
        self.my_tictactoe.set_game()
        self.my_tictactoe.board.result = Result.FIRST_WIN
        self.my_tictactoe.set_result()
        self.assertEqual(self.my_tictactoe.result_text, f"{self.my_tictactoe.player1} voittaa")
        self.my_tictactoe.board.result = Result.SECOND_WIN
        self.my_tictactoe.set_result()
        self.assertEqual(self.my_tictactoe.result_text, f"{self.my_tictactoe.player2} voittaa")
        self.my_tictactoe.board.result = Result.DRAW
        self.my_tictactoe.set_result()
    ...
    def test_draw_right_player(self):
        ...
        self.my_tictactoe.player2 = 'Test2'
        self.my_tictactoe.set_game()
        self.assertEqual(self.my_tictactoe.whose_turn, f"Vuoro: {self.my_tictactoe.player1}")
        self.my_tictactoe.board.whose_turn = 2
        self.my_tictactoe.draw_status()
        self.assertEqual(self.my_tictactoe.whose_turn, f"Vuoro: {self.my_tictactoe.player2}")
...
class TestTicTacToe(unittest.TestCase):
    ...
    def test_variables_after_set_num_squares(self):
        self.my_tictactoe.num_squares = 0
        self.my_tictactoe.player1 = 'Test'
        self.my_tictactoe.player2 = 'Test2'
        self.assertEqual(self.my_tictactoe.num_squares, 0)
        ...
        self.assertTrue(self.my_tictactoe.board == None)
        self.assertTrue(self.my_tictactoe.square_size == 0)
        self.assertTrue(self.my_tictactoe.grid_size == 800)
        self.my_tictactoe.num_squares = 5
        self.my_tictactoe.set_game()
        self.assertTrue(self.my_tictactoe.num_squares <= 30 and self.my_tictactoe.num_squares >= 5)
        self.assertTrue(self.my_tictactoe.screen != None)
        self.assertTrue(self.my_tictactoe.x_image != None)
        self.assertTrue(self.my_tictactoe.o_image != None)
        self.assertTrue(self.my_tictactoe.board != None)
        self.assertTrue(self.my_tictactoe.square_size == int(self.my_tictactoe.grid_size/self.my_tictactoe.num_squares))
        self.assertTrue(self.my_tictactoe.grid_size == self.my_tictactoe.grid_size - (self.my_tictactoe.grid_size % self.my_tictactoe.num_squares))
...
class TestStartMenu(unittest.TestCase):
    ...
    def test_set_num_squares_is_working(self):
        ...
        self.assertTrue(self.start_menu.num_squares != 0)
